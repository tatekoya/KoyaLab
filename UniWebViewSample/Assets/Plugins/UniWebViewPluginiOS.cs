...
public class UniWebViewPlugin {
    ...
    [DllImport("__Internal")]
    private static extern void _UniWebViewSetCookie(string url, string cookie);
    [DllImport("__Internal")]
    private static extern string _UniWebViewGetCookie(string url, string key);
    [DllImport("__Internal")]
    ...
    [DllImport("__Internal")]
    private static extern void _UniWebViewSetAllowAutoPlay(string name, bool value);
    [DllImport("__Internal")]
    private static extern void _UniWebViewSetAllowInlinePlay(string name, bool value);
    ...
    public static string GetCookie(string url, string key) {
        if (Application.platform == RuntimePlatform.IPhonePlayer) {
            return _UniWebViewGetCookie(url, key);
        }
        return "";
    }
    ...
    public static void SetCookie(string url, string cookie) {
        if (Application.platform == RuntimePlatform.IPhonePlayer) {
            _UniWebViewSetCookie(url, cookie);
        }
    }
    ...
    public static void SetAllowAutoPlay(string name, bool value) {
        if (Application.platform == RuntimePlatform.IPhonePlayer) {
            _UniWebViewSetAllowAutoPlay(name, value);
        }
    }

    public static void SetAllowInlinePlay(string name, bool value) {
        if (Application.platform == RuntimePlatform.IPhonePlayer) {
            _UniWebViewSetAllowInlinePlay(name, value);
        }
    }
}
#endif
